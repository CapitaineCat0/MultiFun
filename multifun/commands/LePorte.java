    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
            if (!sender.hasPermission("multifun.leporte") || !sender.hasPermission("multifun.*")) {
                ...
                if (sender instanceof ConsoleCommandSender){
                    ...
                    meta.setLore(Collections.singletonList("La porte ultime réservée aux BG's"));
                    ...
                    meta.addAttributeModifier(Attribute.GENERIC_MOVEMENT_SPEED, new AttributeModifier("generic.movement.speed", 1.0D, AttributeModifier.Operation.ADD_NUMBER));
